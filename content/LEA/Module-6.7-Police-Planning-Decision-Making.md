...
1.  **Analysis:** The planning process begins with a thorough analysis of the situation.
...
2.  **Planning (Developing Alternatives):** Once the problem is understood, the planner develops various possible solutions or courses of action.
...
2.  **Operational Plans (Medium-Range)**
...
1.  **Procedural Plans / Standard Operating Procedures (SOPs)**
