...
The term "Criminology" was coined in the late 19th century, derived from the Latin *crimen* (accusation) and the Greek *logia* (study of).

**Definition (Edwin Sutherland):** Criminology is the body of knowledge regarding crime as a social phenomenon. It includes within its scope the processes of **making laws**, of **breaking laws**, and of **reacting toward the breaking of laws**.

This definition breaks Criminology down into three key areas:
1.  **The Sociology of Law:** The study of how and why societies define certain acts as criminal and how laws are created and enforced.
2.  **Criminal Etiology:** The scientific analysis of the causes of crime and criminal behavior. This is the core of criminology.
...
The study of Criminology covers a very broad range. As defined by Sutherland, its principal divisions are:

### 1. Criminal Etiology (The Causes of Crime)
This is the scientific study of the factors that lead to criminal behavior. It seeks to answer the question, "Why do people commit crime?" This involves looking at a wide range of potential causes:
- **Biological Factors:** Genetics, brain abnormalities, biochemical imbalances.
- **Psychological Factors:** Personality disorders, mental illness, learning deficiencies.
- **Sociological Factors:** Poverty, inequality, social disorganization, peer influence, family dysfunction.

### 2. Sociology of Law
This division studies the nature of criminal law and its administration. It is an attempt to scientifically analyze the conditions under which criminal laws develop and also to explain the procedures used in the enforcement of these laws. It asks questions like:
- Why are some acts defined as criminal while others are not?
- Who has the power to make and enforce laws?
- Does the law apply equally to all people?

### 3. Penology (Corrections)
This division is focused on the control of crime and the treatment of offenders. It studies the various formal and informal methods of social control. This includes the study of:
- **The Criminal Justice System:** The police, courts, and corrections (jails, prisons, probation, and parole).
- **Punishment:** The theories and philosophies of punishment (e.g., retribution, deterrence, rehabilitation).
...
- **Criminology:** Focuses on **explaining the causes of crime**. It is a theoretical, academic field. The primary question is **WHY?**
- **Criminal Justice:** Focuses on the **practical application of laws and the functioning of the agencies** that make up the system (police, courts, corrections). It is an applied, vocational field. The primary question is **HOW?**

**Example:**
- A **criminologist** might study the relationship between poverty and robbery rates to develop a theory about economic strain and crime.
