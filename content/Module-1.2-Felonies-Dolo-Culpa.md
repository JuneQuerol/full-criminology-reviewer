...
-   Analyze and apply the concepts of `error in personae`, `aberratio ictus`, and `praeter intentionem` to case scenarios.
-   Identify the elements of an impossible crime and its corresponding penalty.
...
**Elements of Dolo:**
1.  **Freedom:** The offender must have acted on their own volition, without irresistible force or uncontrollable fear.
2.  **Intelligence:** The offender must have the capacity to understand the nature and consequences of their act.
    -   *Exempting circumstances:* An insane person or a minor under 15 lacks intelligence and thus has no criminal liability.
3.  **Intent:** The offender has the purpose of committing the crime. This is the **criminal intent**.
...
**Elements of Culpa:**
1.  **Imprudence:** Deficiency in action or failing to take the necessary precaution to avoid injury.
    -   *Example:* Recklessly driving a car at high speed in a crowded area.
2.  **Negligence:** Deficiency in perception or failing to foresee a danger that a reasonable person would have foreseen.
...
**Elements:**
1.  The act performed would be an offense against **persons** (e.g., Homicide, Parricide) or **property** (e.g., Theft, Estafa).
2.  The act was done with **evil intent**.
3.  The accomplishment is **inherently impossible** OR the **means employed is inadequate or ineffectual**.
...
**Penalty:**
The penalty for an impossible crime, according to Article 59 of the RPC, is **Arresto Mayor** (1 month and 1 day to 6 months) or a fine ranging from **200 to 500 pesos**. The law penalizes the criminal tendency of the offender.
...
-   **Attempted:** The offender commences the commission of a felony directly by overt acts, but does **not perform all the acts of execution** which should produce the felony by reason of some cause or accident other than their own spontaneous desistance.
...
1.  **Internal Acts:** The mere thought or idea of committing a crime. This is never punishable.
2.  **External Acts:**
...
1.  According to Art. 3 of the Revised Penal Code, felonies are defined as:
    A) Acts and omissions punishable by special laws.
    B) Acts and omissions punishable by the Revised Penal Code.
    C) Only malicious acts punishable by law.
    D) Only wrongful omissions punishable by law.

2.  When a felony is committed with deliberate intent, it is said to be committed by means of:
    A) Culpa
    B) Fault
    C) Dolo
    D) Imprudence

3.  Which of the following is NOT an element of an intentional felony (dolo)?
    A) Freedom
    B) Intelligence
    C) Intent
    D) Negligence

4.  A person driving over the speed limit during a storm hits a pedestrian. What kind of felony is committed?
    A) Intentional Felony
    B) Culpable Felony
    C) Malicious Felony
    D) None of the above

5.  Pedro, wanting to kill Jose, poisons a drink and gives it to him. Jose drinks it and dies. The crime committed is:
    A) Attempted Homicide
    B) Frustrated Homicide
    C) Consummated Homicide
    D) Impossible Crime

6.  Juan aims his gun at Mario, but due to a poor aim, the bullet hits and kills a bystander, Maria. This situation is an example of:
    A) Error in personae
    B) Praeter intentionem
    C) Aberratio ictus
    D) Complex crime of Homicide only

7.  A nurse, intending to kill a patient, injects him with a substance she believes to be poison, but it turns out to be harmless distilled water. What crime is committed?
    A) Attempted Murder
    B) Frustrated Murder
    C) Impossible Crime
    D) No crime is committed

8.  Which of the following is NOT a requisite of an impossible crime?
    A) The act performed would be an offense against persons or property.
    B) The act was done with evil intent.
    C) The felony was actually produced.
    D) The means used was ineffectual or the accomplishment was inherently impossible.

9.  Which stage of execution is present when the offender performs all acts that would produce the felony, but it is not produced due to causes independent of his will?
    A) Consummated
    B) Frustrated
    C) Attempted
    D) Preparatory

10. Spontaneous desistance by the offender will prevent criminal liability in which stage?
    A) In the consummated stage, as a mitigating circumstance.
    B) In the frustrated stage.
    C) In the attempted stage.
    D) Spontaneous desistance never affects criminal liability.

11. X decides to rob a bank and convinces Y and Z to join him. They agree on a plan. What crime has been committed at this point?
    A) Proposal to Commit Robbery
    B) Conspiracy to Commit Robbery
    C) Attempted Robbery
    D) No crime is committed yet.

12. The injurious result of the crime is greater than that intended by the offender. This is known as:
    A) Error in personae
    B) Aberratio ictus
    C) Praeter intentionem
    D) Dolus malus

13. Which of the following is an example of a felony by omission?
    A) A security guard shooting a robber.
    B) A driver failing to stop at a red light.
    C) A lifeguard who intentionally refrains from saving a drowning person he is duty-bound to save.
    D) A person shouting in a library.

14. For a culpable felony to exist, which of the following must be present?
    A) Malice
    B) Criminal Intent
    C) Imprudence or Negligence
    D) Deliberate will to cause injury

15. X tried to kill Y by stabbing him. Y was brought to the hospital and survived because of the timely and skillful intervention of the doctors. X is liable for:
    A) Frustrated Homicide
    B) Attempted Homicide
    C) Consummated Homicide
    D) Serious Physical Injuries

16. Which of the following preparatory acts is generally punishable under the Revised Penal Code?
    A) Conspiracy to commit theft.
    B) Proposal to commit homicide.
    C) Conspiracy to commit rebellion.
    D) All preparatory acts are punishable.

17. Mario wanted to steal a specific antique vase from a museum. He broke in at night but was immediately caught by the guards before he could get near the vase. What crime did Mario commit?
    A) Consummated Theft
    B) Frustrated Theft
    C) Attempted Theft
    D) Impossible Crime

18. What is the key difference between the frustrated and attempted stages of a felony?
    A) The intent of the offender.
    B) The presence of an external cause preventing the crime.
    C) The offender performs ALL acts of execution in the frustrated stage, but not in the attempted stage.
    D) The gravity of the resulting injury.

19. X mistakes Y for a deer and shoots him. What is the basis of X's liability?
    A) Dolo, because there was intent to shoot.
    B) Culpa, due to negligence.
    C) No liability because of mistake of fact.
    D) Praeter intentionem.

20. What is the legal effect of `praeter intentionem` in a criminal case?
    A) It is an exempting circumstance.
    B) It is a justifying circumstance.
    C) It is a mitigating circumstance.
    D) It is an aggravating circumstance.

21. A pickpocket puts his hand in the victim's pocket, intending to steal the wallet, but finds the pocket empty. What crime is committed?
    A) Attempted Theft
    B) Frustrated Theft
    C) Consummated Theft
    D) Impossible Crime to commit Theft

22. In `error in personae`, the offender:
    A) Hits a person other than the intended victim by mistake in the blow.
    B) Intends a lesser crime but a graver one results.
    C) Commits a crime on a person different from the one he intended to victimize.
    D) Uses ineffectual means to commit a crime.

23. The general rule is that conspiracy is not a crime. Which of the following is an exception?
    A) Conspiracy to commit murder.
    B) Conspiracy to commit sedition.
    C) Conspiracy to commit estafa.
    D) Conspiracy to commit physical injuries.

24. A person who acts with lack of skill is liable for a felony by:
    A) Dolo
    B) Malice
    C) Culpa
    D) Intent

25. The "overt act" required for an attempted felony must be:
    A) A preparatory act.
    B) An act that has a direct connection to the crime intended to be committed.
    C) The final act that will consummate the crime.
    D) An act that is not punishable by law.

---

#### **Answer Key and Explanations**

1.  **B) Acts and omissions punishable by the Revised Penal Code.**
...
8.  **C) The felony was actually produced.**
...
11. **D) No crime is committed yet.**
...
13. **C) A lifeguard who intentionally refrains from saving a drowning person he is duty-bound to save.**
    *   **Explanation:** An omission is the failure to perform a duty required by law. The lifeguard has a specific legal duty to act.

14. **C) Imprudence or Negligence**
...
18. **C) The offender performs ALL acts of execution in the frustrated stage, but not in the attempted stage.**
    *   **Explanation:** This is the primary distinction between the two stages.

19. **B) Culpa, due to negligence.**
...
20. **C) It is a mitigating circumstance.**
...
21. **D) Impossible Crime to commit Theft**
...
22. **C) Commits a crime on a person different from the one he intended to victimize.**
    *   **Explanation:** This is the definition of `error in personae`, or mistake in identity.

23. **B) Conspiracy to commit sedition.**
...
25. **B) An act that has a direct connection to the crime intended to be committed.**
